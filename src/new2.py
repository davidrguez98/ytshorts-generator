...
audio = AudioFileClip("./data/audio/2.mp3")

subtitle_srt = pysrt.open("./data/subtitles/2.srt", encoding='utf-8')
...
def main_new2():
    ...
    video_copilation.write_videofile("./videos/new2.mp4", fps=24)
